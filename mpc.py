...
class MPC():
    def __init__(self, x0, v0, theta0, thetadot0):
        ...
        self.m.setup(P=P, q=q, A=A, l=l, u=u, time_limit=0.1, verbose=False)
    ...
    def constraint(self, var, x0, v0, th0, thd0):
        ...
        xavg, vavg, thetavg, thdotavg = map(
            lambda z: (z[0:-1]+z[1:])/2, dynvars)
    ...
    def getAlu(self, x, x0, v0, th0, thd0):
        ...
        cons = self.constraint(
            forward.seed_sparse_gradient(x), x0, v0, th0, thd0)
